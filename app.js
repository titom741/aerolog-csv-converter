...
const TRANSLATIONS = {
  ...
  es: {
    ...
    page_title_file: "Convertidor CSV/XLSX de AeroLog",
    ...
    hero_title_file_html: "CSV/XLSX a <code>Flights.json</code>, <code>Pilots.json</code> y <code>Aircrafts.json</code>",
    hero_copy_file: "Esta página lee un archivo CSV o XLSX, detecta automáticamente las columnas conocidas, valida los campos mínimos requeridos y genera los tres archivos JSON esperados por la app.",
    choose_csv: "Elegir un CSV",
    choose_file: "Elegir un CSV o XLSX",
    download_csv_template: "Descargar plantilla CSV",
    download_xlsx_template: "Descargar plantilla XLSX",
    hero_how_copy_file: "Carga un archivo CSV o XLSX, arrastra las etiquetas esperadas a las columnas correctas, corrige las señales naranjas o rojas y luego descarga los tres archivos JSON.",
    ...
    template_hint_html: "En la plantilla CSV, los encabezados obligatorios empiezan por <code>*</code>. En la plantilla XLSX, los encabezados obligatorios están en negrita.",
    ...
    header_overrides_title_file: "Editor de encabezados CSV/XLSX",
    header_overrides_copy_file: "Arrastra una etiqueta esperada sobre una columna CSV o XLSX para renombrarla automáticamente, o edítala manualmente. También puedes añadir o eliminar encabezados.",
    header_overrides_placeholder_file: "Carga un archivo CSV o XLSX para editar los nombres de las columnas.",
    ...
    xlsx_parse_error: "No se pudo leer el archivo XLSX.",
    xlsx_missing_sheet: "No se encontró ninguna hoja en este archivo XLSX.",
  ...
  de: {
    ...
    page_title_file: "AeroLog CSV/XLSX-Konverter",
    ...
    hero_title_file_html: "CSV/XLSX zu <code>Flights.json</code>, <code>Pilots.json</code> und <code>Aircrafts.json</code>",
    hero_copy_file: "Diese Seite liest eine CSV- oder XLSX-Datei, erkennt bekannte Spalten automatisch, prüft die erforderlichen Mindestfelder und erzeugt die drei JSON-Dateien, die die App erwartet.",
    choose_csv: "CSV auswählen",
    choose_file: "CSV oder XLSX auswählen",
    download_csv_template: "CSV-Vorlage herunterladen",
    download_xlsx_template: "XLSX-Vorlage herunterladen",
    hero_how_copy_file: "Laden Sie eine CSV- oder XLSX-Datei, ziehen Sie die erwarteten Bezeichnungen auf die richtigen Spalten, beheben Sie orange oder rote Hinweise und laden Sie dann die drei JSON-Dateien herunter.",
    ...
    template_hint_html: "In der CSV-Vorlage beginnen Pflichtfelder mit <code>*</code>. In der XLSX-Vorlage sind Pflichtfelder fett dargestellt.",
    ...
    header_overrides_title_file: "CSV/XLSX-Header-Editor",
    header_overrides_copy_file: "Ziehen Sie eine erwartete Bezeichnung auf eine CSV- oder XLSX-Spalte, um sie automatisch umzubenennen, oder bearbeiten Sie sie manuell. Sie können auch Header hinzufügen oder entfernen.",
    header_overrides_placeholder_file: "Laden Sie eine CSV- oder XLSX-Datei, um die Spaltennamen zu bearbeiten.",
    ...
    xlsx_parse_error: "Die XLSX-Datei konnte nicht gelesen werden.",
    xlsx_missing_sheet: "In dieser XLSX-Datei wurde kein Arbeitsblatt gefunden.",
  ...
  it: {
    ...
    page_title_file: "Convertitore CSV/XLSX AeroLog",
    ...
    hero_title_file_html: "CSV/XLSX in <code>Flights.json</code>, <code>Pilots.json</code> e <code>Aircrafts.json</code>",
    hero_copy_file: "Questa pagina legge un file CSV o XLSX, rileva automaticamente le colonne conosciute, valida i campi minimi richiesti e genera i tre file JSON attesi dall'app.",
    choose_csv: "Scegli un CSV",
    choose_file: "Scegli un CSV o XLSX",
    download_csv_template: "Scarica modello CSV",
    download_xlsx_template: "Scarica modello XLSX",
    hero_how_copy_file: "Carica un file CSV o XLSX, trascina le etichette previste sulle colonne corrette, correggi i segnali arancioni o rossi e poi scarica i tre file JSON.",
    ...
    template_hint_html: "Nel modello CSV, le intestazioni obbligatorie iniziano con <code>*</code>. Nel modello XLSX, le intestazioni obbligatorie sono in grassetto.",
    ...
    header_overrides_title_file: "Editor header CSV/XLSX",
    header_overrides_copy_file: "Trascina un'etichetta prevista su una colonna CSV o XLSX per rinominarla automaticamente, oppure modificala manualmente. Puoi anche aggiungere o rimuovere header.",
    header_overrides_placeholder_file: "Carica un file CSV o XLSX per modificare i nomi delle colonne.",
    ...
    xlsx_parse_error: "Impossibile leggere il file XLSX.",
    xlsx_missing_sheet: "Nessun foglio trovato in questo file XLSX.",
  ...
  pt: {
    ...
    page_title_file: "Conversor CSV/XLSX AeroLog",
    ...
    hero_title_file_html: "CSV/XLSX para <code>Flights.json</code>, <code>Pilots.json</code> e <code>Aircrafts.json</code>",
    hero_copy_file: "Esta página lê um arquivo CSV ou XLSX, detecta automaticamente colunas conhecidas, valida os campos mínimos obrigatórios e gera os três arquivos JSON esperados pelo app.",
    choose_csv: "Escolher um CSV",
    choose_file: "Escolher um CSV ou XLSX",
    download_csv_template: "Baixar modelo CSV",
    download_xlsx_template: "Baixar modelo XLSX",
    hero_how_copy_file: "Carregue um arquivo CSV ou XLSX, arraste os rótulos esperados para as colunas corretas, corrija os sinais laranja ou vermelhos e depois baixe os três arquivos JSON.",
    ...
    template_hint_html: "No modelo CSV, os cabeçalhos obrigatórios começam com <code>*</code>. No modelo XLSX, os cabeçalhos obrigatórios estão em negrito.",
    ...
    header_overrides_title_file: "Editor de cabeçalhos CSV/XLSX",
    header_overrides_copy_file: "Arraste um rótulo esperado para uma coluna CSV ou XLSX para renomeá-la automaticamente, ou edite manualmente. Você também pode adicionar ou remover cabeçalhos.",
    header_overrides_placeholder_file: "Carregue um arquivo CSV ou XLSX para editar os nomes das colunas.",
    ...
    xlsx_parse_error: "Não foi possível ler o arquivo XLSX.",
    xlsx_missing_sheet: "Nenhuma planilha foi encontrada neste arquivo XLSX.",
  ...
  nl: {
    ...
    hero_title_file_html: "CSV/XLSX naar <code>Flights.json</code>, <code>Pilots.json</code> en <code>Aircrafts.json</code>",
    hero_copy_file: "Deze pagina leest één CSV- of XLSX-bestand, herkent bekende kolommen automatisch, controleert de minimaal vereiste velden en genereert de drie JSON-bestanden die de app verwacht.",
    choose_csv: "Kies een CSV",
    choose_file: "Kies een CSV of XLSX",
    download_csv_template: "CSV-sjabloon downloaden",
    download_xlsx_template: "XLSX-sjabloon downloaden",
    hero_how_copy_file: "Laad een CSV- of XLSX-bestand, sleep de verwachte labels naar de juiste kolommen, los oranje of rode signalen op en download daarna de drie JSON-bestanden.",
    ...
    template_hint_html: "In het CSV-sjabloon beginnen verplichte kopteksten met <code>*</code>. In het XLSX-sjabloon zijn verplichte kopteksten vetgedrukt.",
    ...
    header_overrides_title_file: "CSV/XLSX-headereditor",
    header_overrides_copy_file: "Sleep een verwacht label naar een CSV- of XLSX-kolom om deze automatisch te hernoemen, of wijzig het handmatig. Je kunt ook kopteksten toevoegen of verwijderen.",
    header_overrides_placeholder_file: "Laad een CSV- of XLSX-bestand om kolomnamen te bewerken.",
    ...
    xlsx_parse_error: "Het XLSX-bestand kon niet worden gelezen.",
    xlsx_missing_sheet: "Er is geen werkblad gevonden in dit XLSX-bestand.",
  ...
  pl: {
    ...
    page_title_file: "Konwerter CSV/XLSX AeroLog",
    ...
    hero_title_file_html: "CSV/XLSX do <code>Flights.json</code>, <code>Pilots.json</code> i <code>Aircrafts.json</code>",
    hero_copy_file: "Ta strona odczytuje plik CSV lub XLSX, automatycznie wykrywa znane kolumny, sprawdza minimalne wymagane pola i generuje trzy pliki JSON oczekiwane przez aplikację.",
    choose_csv: "Wybierz plik CSV",
    choose_file: "Wybierz plik CSV lub XLSX",
    download_csv_template: "Pobierz szablon CSV",
    download_xlsx_template: "Pobierz szablon XLSX",
    hero_how_copy_file: "Wczytaj plik CSV lub XLSX, przeciągnij oczekiwane etykiety na właściwe kolumny, popraw pomarańczowe lub czerwone sygnały, a następnie pobierz trzy pliki JSON.",
    ...
    template_hint_html: "W szablonie CSV wymagane nagłówki zaczynają się od <code>*</code>. W szablonie XLSX wymagane nagłówki są pogrubione.",
    ...
    header_overrides_title_file: "Edytor nagłówków CSV/XLSX",
    header_overrides_copy_file: "Przeciągnij oczekiwaną etykietę na kolumnę CSV lub XLSX, aby automatycznie zmienić jej nazwę, albo edytuj ją ręcznie. Możesz też dodawać i usuwać nagłówki.",
    header_overrides_placeholder_file: "Wczytaj plik CSV lub XLSX, aby edytować nazwy kolumn.",
    ...
    xlsx_parse_error: "Nie udało się odczytać pliku XLSX.",
    xlsx_missing_sheet: "Nie znaleziono arkusza w tym pliku XLSX.",
  ...
  tr: {
    ...
    page_title_file: "AeroLog CSV/XLSX Dönüştürücü",
    ...
    hero_title_file_html: "CSV/XLSX'ten <code>Flights.json</code>, <code>Pilots.json</code> ve <code>Aircrafts.json</code>",
    hero_copy_file: "Bu sayfa bir CSV veya XLSX dosyasını okur, bilinen sütunları otomatik algılar, gerekli asgari alanları doğrular ve uygulamanın beklediği üç JSON dosyasını üretir.",
    choose_csv: "CSV seç",
    choose_file: "CSV veya XLSX seç",
    download_csv_template: "CSV şablonunu indir",
    download_xlsx_template: "XLSX şablonunu indir",
    hero_how_copy_file: "Bir CSV veya XLSX dosyası yükleyin, beklenen etiketleri doğru sütunlara sürükleyin, turuncu veya kırmızı sinyalleri düzeltin ve ardından üç JSON dosyasını indirin.",
    ...
    template_hint_html: "CSV şablonunda zorunlu başlıklar <code>*</code> ile başlar. XLSX şablonunda zorunlu başlıklar kalın yazılır.",
    ...
    header_overrides_title_file: "CSV/XLSX başlık düzenleyici",
    header_overrides_copy_file: "Beklenen bir etiketi bir CSV veya XLSX sütununun üzerine sürükleyerek onu otomatik yeniden adlandırın ya da elle düzenleyin. Ayrıca başlık ekleyebilir veya kaldırabilirsiniz.",
    header_overrides_placeholder_file: "Sütun adlarını düzenlemek için bir CSV veya XLSX dosyası yükleyin.",
    ...
    xlsx_parse_error: "XLSX dosyası okunamadı.",
    xlsx_missing_sheet: "Bu XLSX dosyasında çalışma sayfası bulunamadı.",
  ...
  ru: {
    ...
    page_title_file: "Конвертер CSV/XLSX AeroLog",
    ...
    hero_title_file_html: "CSV/XLSX в <code>Flights.json</code>, <code>Pilots.json</code> и <code>Aircrafts.json</code>",
    hero_copy_file: "Эта страница читает CSV- или XLSX-файл, автоматически распознает известные столбцы, проверяет минимально обязательные поля и формирует три JSON-файла, ожидаемые приложением.",
    choose_csv: "Выбрать CSV",
    choose_file: "Выбрать CSV или XLSX",
    download_csv_template: "Скачать шаблон CSV",
    download_xlsx_template: "Скачать шаблон XLSX",
    hero_how_copy_file: "Загрузите CSV- или XLSX-файл, перетащите ожидаемые метки на нужные столбцы, исправьте оранжевые или красные сигналы, а затем скачайте три JSON-файла.",
    ...
    template_hint_html: "В шаблоне CSV обязательные заголовки начинаются с <code>*</code>. В шаблоне XLSX обязательные заголовки выделены жирным.",
    ...
    header_overrides_title_file: "Редактор заголовков CSV/XLSX",
    header_overrides_copy_file: "Перетащите ожидаемую метку на столбец CSV или XLSX, чтобы автоматически переименовать его, либо измените название вручную. Вы также можете добавлять или удалять заголовки.",
    header_overrides_placeholder_file: "Загрузите CSV- или XLSX-файл, чтобы изменить названия столбцов.",
    ...
    xlsx_parse_error: "Не удалось прочитать XLSX-файл.",
    xlsx_missing_sheet: "В этом XLSX-файле не найден ни один лист.",
  ...
  ar: {
    ...
    page_title_file: "محول CSV/XLSX من AeroLog",
    ...
    hero_title_file_html: "من CSV/XLSX إلى <code>Flights.json</code> و<code>Pilots.json</code> و<code>Aircrafts.json</code>",
    hero_copy_file: "تقرأ هذه الصفحة ملف CSV أو XLSX، وتتعرف تلقائيًا على الأعمدة المعروفة، وتتحقق من الحد الأدنى من الحقول المطلوبة، ثم تنشئ ملفات JSON الثلاثة التي يتوقعها التطبيق.",
    choose_csv: "اختر ملف CSV",
    choose_file: "اختر ملف CSV أو XLSX",
    download_csv_template: "تنزيل قالب CSV",
    download_xlsx_template: "تنزيل قالب XLSX",
    hero_how_copy_file: "حمّل ملف CSV أو XLSX، واسحب التسميات المتوقعة إلى الأعمدة الصحيحة، وصحّح الإشارات البرتقالية أو الحمراء، ثم نزّل ملفات JSON الثلاثة.",
    ...
    template_hint_html: "في قالب CSV، تبدأ العناوين المطلوبة بـ <code>*</code>. وفي قالب XLSX، تكون العناوين المطلوبة بخط عريض.",
    ...
    header_overrides_title_file: "محرر رؤوس CSV/XLSX",
    header_overrides_copy_file: "اسحب تسمية متوقعة إلى عمود CSV أو XLSX لإعادة تسميته تلقائيًا، أو عدّله يدويًا. يمكنك أيضًا إضافة الرؤوس أو حذفها.",
    header_overrides_placeholder_file: "حمّل ملف CSV أو XLSX لتعديل أسماء الأعمدة.",
    ...
    xlsx_parse_error: "تعذر قراءة ملف XLSX.",
    xlsx_missing_sheet: "لم يتم العثور على أي ورقة في ملف XLSX هذا.",
  ...
  hi: {
    ...
    page_title_file: "AeroLog CSV/XLSX कन्वर्टर",
    ...
    hero_title_file_html: "CSV/XLSX से <code>Flights.json</code>, <code>Pilots.json</code> और <code>Aircrafts.json</code>",
    hero_copy_file: "यह पेज एक CSV या XLSX फ़ाइल पढ़ता है, ज्ञात कॉलम अपने आप पहचानता है, न्यूनतम आवश्यक फ़ील्ड जाँचता है और ऐप के लिए अपेक्षित तीन JSON फ़ाइलें बनाता है।",
    choose_csv: "CSV चुनें",
    choose_file: "CSV या XLSX चुनें",
    download_csv_template: "CSV टेम्पलेट डाउनलोड करें",
    download_xlsx_template: "XLSX टेम्पलेट डाउनलोड करें",
    hero_how_copy_file: "CSV या XLSX फ़ाइल लोड करें, अपेक्षित लेबल सही कॉलम पर ड्रैग करें, नारंगी या लाल संकेत ठीक करें, फिर तीनों JSON फ़ाइलें डाउनलोड करें।",
    ...
    template_hint_html: "CSV टेम्पलेट में आवश्यक हेडर <code>*</code> से शुरू होते हैं। XLSX टेम्पलेट में आवश्यक हेडर बोल्ड होते हैं।",
    ...
    header_overrides_title_file: "CSV/XLSX हेडर संपादक",
    header_overrides_copy_file: "किसी अपेक्षित लेबल को CSV या XLSX कॉलम पर ड्रैग करके उसका नाम अपने आप बदलें, या उसे मैन्युअली संपादित करें। आप हेडर जोड़ या हटा भी सकते हैं।",
    header_overrides_placeholder_file: "कॉलम नाम संपादित करने के लिए CSV या XLSX फ़ाइल लोड करें।",
    ...
    xlsx_parse_error: "XLSX फ़ाइल पढ़ी नहीं जा सकी।",
    xlsx_missing_sheet: "इस XLSX फ़ाइल में कोई शीट नहीं मिली।",
  ...
  zh: {
    ...
    page_title_file: "AeroLog CSV/XLSX 转换器",
    ...
    hero_title_file_html: "CSV/XLSX 转为 <code>Flights.json</code>、<code>Pilots.json</code> 和 <code>Aircrafts.json</code>",
    hero_copy_file: "此页面可读取单个 CSV 或 XLSX 文件，自动识别已知列，校验最少必填字段，并生成应用所需的三个 JSON 文件。",
    choose_csv: "选择 CSV",
    choose_file: "选择 CSV 或 XLSX",
    download_csv_template: "下载 CSV 模板",
    download_xlsx_template: "下载 XLSX 模板",
    hero_how_copy_file: "加载 CSV 或 XLSX 文件，将预期标签拖到正确的列上，修复橙色或红色提示，然后下载三个 JSON 文件。",
    output_filenames_html: "输出文件名始终为 <code>Flights.json</code>、<code>Pilots.json</code> 和 <code>Aircrafts.json</code>。",
    template_hint_html: "在 CSV 模板中，必填表头以 <code>*</code> 开头。在 XLSX 模板中，必填表头会以粗体显示。",
    ...
    header_overrides_title_file: "CSV/XLSX 表头编辑器",
    header_overrides_copy_file: "将预期标签拖到 CSV 或 XLSX 列上即可自动重命名，也可以手动修改。你也可以添加或删除表头。",
    header_overrides_placeholder_file: "加载 CSV 或 XLSX 文件以编辑列名。",
    mapping_title: "列映射",
    ...
    csv_empty: "CSV 文件为空。",
    xlsx_parse_error: "无法读取 XLSX 文件。",
    xlsx_missing_sheet: "此 XLSX 文件中未找到任何工作表。",
  ...
  ja: {
    ...
    page_title_file: "AeroLog CSV/XLSX コンバーター",
    ...
    hero_title_file_html: "CSV/XLSX から <code>Flights.json</code>、<code>Pilots.json</code>、<code>Aircrafts.json</code> を生成",
    hero_copy_file: "このページは 1 つの CSV または XLSX ファイルを読み込み、既知の列を自動検出し、最低限必要な項目を検証して、アプリが必要とする 3 つの JSON ファイルを生成します。",
    choose_csv: "CSV を選択",
    choose_file: "CSV または XLSX を選択",
    download_csv_template: "CSV テンプレートをダウンロード",
    download_xlsx_template: "XLSX テンプレートをダウンロード",
    hero_how_copy_file: "CSV または XLSX ファイルを読み込み、想定ラベルを正しい列へドラッグし、オレンジ色や赤色の警告を修正してから、3 つの JSON ファイルをダウンロードしてください。",
    output_filenames_html: "出力ファイル名は常に <code>Flights.json</code>、<code>Pilots.json</code>、<code>Aircrafts.json</code> です。",
    template_hint_html: "CSV テンプレートでは必須ヘッダーは <code>*</code> で始まります。XLSX テンプレートでは必須ヘッダーが太字になります。",
    ...
    header_overrides_title_file: "CSV/XLSX ヘッダーエディター",
    header_overrides_copy_file: "想定ラベルを CSV または XLSX の列へドラッグすると自動で名前を変更できます。手動で編集することもでき、ヘッダーの追加や削除も可能です。",
    header_overrides_placeholder_file: "列名を編集するには CSV または XLSX ファイルを読み込んでください。",
    ...
    xlsx_parse_error: "XLSX ファイルを読み込めませんでした。",
    xlsx_missing_sheet: "この XLSX ファイルにはワークシートが見つかりませんでした。",
  ...
  ko: {
    ...
    page_title_file: "AeroLog CSV/XLSX 변환기",
    ...
    hero_title_file_html: "CSV/XLSX를 <code>Flights.json</code>, <code>Pilots.json</code>, <code>Aircrafts.json</code>로 변환",
    hero_copy_file: "이 페이지는 하나의 CSV 또는 XLSX 파일을 읽고, 알려진 열을 자동으로 인식하며, 최소 필수 항목을 검증한 뒤 앱에서 기대하는 세 개의 JSON 파일을 생성합니다.",
    choose_csv: "CSV 선택",
    choose_file: "CSV 또는 XLSX 선택",
    download_csv_template: "CSV 템플릿 다운로드",
    download_xlsx_template: "XLSX 템플릿 다운로드",
    hero_how_copy_file: "CSV 또는 XLSX 파일을 불러오고, 예상 라벨을 올바른 열로 드래그한 뒤, 주황색 또는 빨간색 신호를 수정하고, 마지막으로 세 개의 JSON 파일을 다운로드하세요.",
    output_filenames_html: "출력 파일 이름은 항상 <code>Flights.json</code>, <code>Pilots.json</code>, <code>Aircrafts.json</code>입니다.",
    template_hint_html: "CSV 템플릿에서는 필수 헤더가 <code>*</code>로 시작합니다. XLSX 템플릿에서는 필수 헤더가 굵게 표시됩니다.",
    ...
    header_overrides_title_file: "CSV/XLSX 헤더 편집기",
    header_overrides_copy_file: "예상 라벨을 CSV 또는 XLSX 열로 드래그하면 자동으로 이름을 바꿀 수 있고, 직접 수정할 수도 있습니다. 헤더를 추가하거나 삭제할 수도 있습니다.",
    header_overrides_placeholder_file: "열 이름을 수정하려면 CSV 또는 XLSX 파일을 불러오세요.",
    mapping_title: "열 매핑",
    ...
    xlsx_parse_error: "XLSX 파일을 읽을 수 없습니다.",
    xlsx_missing_sheet: "이 XLSX 파일에서 워크시트를 찾을 수 없습니다.",
...
const TRANSLATION_COMPLEMENTS = {
  es: {
    ...
    hero_how_title: "Cómo usarla",
    hero_how_copy: "Carga un CSV, arrastra las etiquetas esperadas a las columnas correctas, corrige las señales naranjas o rojas y luego descarga los tres archivos JSON.",
    hero_minimums_title: "Campos mínimos",
    hero_minimums_copy_html: "<strong>Vuelo</strong>: fecha, matrícula, piloto 1 y tiempo total de aeronave o simulador.<br><strong>Aeronave</strong>: fabricante y modelo.<br><strong>Ruta</strong>: salida y llegada para filas que no sean de simulador.",
    header_overrides_title: "Editor de encabezados CSV",
    header_overrides_copy: "Arrastra una etiqueta esperada a una columna para renombrarla automáticamente, o edítala manualmente. También puedes añadir o eliminar encabezados.",
    header_overrides_add: "Añadir encabezado",
    header_overrides_reset: "Restablecer nombres",
    expected_fields_copy: "Arrastra una de las etiquetas esperadas de abajo a una columna del CSV.",
    legend_validated: "Verde: etiqueta validada",
    legend_optional: "Azul: etiqueta opcional reconocida",
    legend_unrecognized: "Naranja: columna no reconocida a revisar",
    legend_error: "Rojo: problema bloqueante por corregir",
    editor_metric_validated: "Validadas",
    editor_metric_unrecognized: "No reconocidas",
    editor_metric_missing: "Obligatorias faltantes",
    editor_metric_errors: "Errores bloqueantes",
    editor_metric_warnings: "Avisos",
    editor_missing_required_title: "Etiquetas obligatorias faltantes",
    problematic_rows_title: "Filas problemáticas",
    problematic_rows_empty: "No se ha detectado ningún problema por fila.",
    problematic_row_heading: "Línea {lineNumber}",
    blocking_errors_row_issues: "{count} problema(s) en esta línea",
    problematic_row_hint: "Los campos marcados con * son obligatorios.",
    problematic_row_save: "Validar cambios",
    problematic_row_delete: "Eliminar línea",
    problematic_row_no_fields: "No se ha detectado ningún campo editable para esta línea.",
    problematic_row_close: "Cerrar editor",
    header_original_column: "Columna original",
    header_rename_to: "Renombrar a",
    header_editor_action: "Acción",
    header_detected_target: "Reconocimiento",
    header_overrides_placeholder: "Carga un CSV para editar los nombres de las columnas.",
    header_manual_column: "Encabezado manual",
    header_default_value_label: "Valor por defecto",
    header_default_value_placeholder: "Se aplica a todas las filas",
    header_default_value_missing: "Añade un valor por defecto para completar todas las filas.",
    header_derived_column: "Columna derivada",
    header_derived_from: "Extraída de {original}",
    header_derived_sample: "Valor de ejemplo: {value}",
    header_auto_split_time: "Hora integrada detectada: se crea {header}.",
    header_remove: "Eliminar",
    header_restore: "Restaurar",
    header_delete: "Borrar",
    header_removed: "Eliminada",
    header_status_validated: "Validada",
    header_status_optional: "Coincidencia opcional",
    header_status_unrecognized: "Requiere revisión",
    header_status_removed: "Ignorada",
    untitled_header: "Columna sin título #{index}",
    header_match_none: "Aún sin coincidencia",
    header_renamed_from: "de {original}",
    header_override_duplicate_error: "Dos o más columnas usan ahora el mismo nombre final: {headers}. Da a cada columna un nombre final único.",
  ...
  de: {
    ...
    hero_how_title: "So wird sie verwendet",
    hero_how_copy: "Laden Sie eine CSV, ziehen Sie die erwarteten Bezeichnungen auf die richtigen Spalten, beheben Sie orange oder rote Hinweise und laden Sie dann die drei JSON-Dateien herunter.",
    hero_minimums_title: "Mindestfelder",
    hero_minimums_copy_html: "<strong>Flug</strong>: Datum, Kennzeichen, Pilot 1 und Gesamtzeit Flugzeug oder Simulator.<br><strong>Flugzeug</strong>: Hersteller und Modell.<br><strong>Route</strong>: Abflug und Ankunft für Zeilen, die keine Simulator-Sitzungen sind.",
    header_overrides_title: "CSV-Header-Editor",
    header_overrides_copy: "Ziehen Sie eine erwartete Bezeichnung auf eine Spalte, um sie automatisch umzubenennen, oder bearbeiten Sie sie manuell. Sie können auch Header hinzufügen oder entfernen.",
    header_overrides_add: "Header hinzufügen",
    header_overrides_reset: "Umbenennungen zurücksetzen",
    expected_fields_copy: "Ziehen Sie eine der erwarteten Bezeichnungen unten auf eine CSV-Spalte.",
    legend_validated: "Grün: bestätigte Bezeichnung",
    legend_optional: "Blau: erkannte optionale Bezeichnung",
    legend_unrecognized: "Orange: nicht erkannte Spalte zur Prüfung",
    legend_error: "Rot: blockierendes Problem, das behoben werden muss",
    editor_metric_validated: "Bestätigt",
    editor_metric_unrecognized: "Nicht erkannt",
    editor_metric_missing: "Pflichtfelder fehlen",
    editor_metric_errors: "Blockierende Fehler",
    editor_metric_warnings: "Warnungen",
    editor_missing_required_title: "Fehlende Pflichtbezeichnungen",
    problematic_rows_title: "Problematische Zeilen",
    problematic_rows_empty: "Es wurden keine zeilenbezogenen Probleme erkannt.",
    problematic_row_heading: "Zeile {lineNumber}",
    blocking_errors_row_issues: "{count} Problem(e) in dieser Zeile",
    problematic_row_hint: "Mit * markierte Felder sind erforderlich.",
    problematic_row_save: "Änderungen bestätigen",
    problematic_row_delete: "Zeile löschen",
    problematic_row_no_fields: "Für diese Zeile wurde kein bearbeitbares Feld erkannt.",
    problematic_row_close: "Editor schließen",
    header_original_column: "Ursprüngliche Spalte",
    header_rename_to: "Umbenennen in",
    header_editor_action: "Aktion",
    header_detected_target: "Erkennung",
    header_overrides_placeholder: "Laden Sie eine CSV, um Spaltennamen zu bearbeiten.",
    header_manual_column: "Manueller Header",
    header_default_value_label: "Standardwert",
    header_default_value_placeholder: "Wird auf alle Zeilen angewendet",
    header_default_value_missing: "Fügen Sie einen Standardwert hinzu, um alle Zeilen zu füllen.",
    header_derived_column: "Abgeleitete Spalte",
    header_derived_from: "Abgeleitet aus {original}",
    header_derived_sample: "Beispielwert: {value}",
    header_auto_split_time: "Eingebettete Uhrzeit erkannt: {header} wird erstellt.",
    header_remove: "Entfernen",
    header_restore: "Wiederherstellen",
    header_delete: "Löschen",
    header_removed: "Entfernt",
    header_status_validated: "Bestätigt",
    header_status_optional: "Optionale Zuordnung",
    header_status_unrecognized: "Prüfung nötig",
    header_status_removed: "Ignoriert",
    untitled_header: "Unbenannte Spalte #{index}",
    header_match_none: "Noch nicht zugeordnet",
    header_renamed_from: "von {original}",
    header_override_duplicate_error: "Zwei oder mehr Spalten verwenden jetzt denselben endgültigen Namen: {headers}. Geben Sie jeder Spalte einen eindeutigen endgültigen Namen.",
  ...
  it: {
    ...
    hero_how_title: "Come usarla",
    hero_how_copy: "Carica un CSV, trascina le etichette previste sulle colonne corrette, correggi i segnali arancioni o rossi e poi scarica i tre file JSON.",
    hero_minimums_title: "Campi minimi",
    hero_minimums_copy_html: "<strong>Volo</strong>: data, immatricolazione, pilota 1 e tempo totale velivolo o simulatore.<br><strong>Aeromobile</strong>: costruttore e modello.<br><strong>Rotta</strong>: partenza e arrivo per le righe che non sono sessioni di simulatore.",
    header_overrides_title: "Editor header CSV",
    header_overrides_copy: "Trascina un'etichetta prevista su una colonna per rinominarla automaticamente, oppure modificala manualmente. Puoi anche aggiungere o rimuovere header.",
    header_overrides_add: "Aggiungi header",
    header_overrides_reset: "Reimposta rinomina",
    expected_fields_copy: "Trascina una delle etichette previste qui sotto su una colonna del CSV.",
    legend_validated: "Verde: etichetta validata",
    legend_optional: "Blu: etichetta opzionale riconosciuta",
    legend_unrecognized: "Arancione: colonna non riconosciuta da controllare",
    legend_error: "Rosso: problema bloccante da correggere",
    editor_metric_validated: "Validate",
    editor_metric_unrecognized: "Non riconosciute",
    editor_metric_missing: "Obbligatorie mancanti",
    editor_metric_errors: "Errori bloccanti",
    editor_metric_warnings: "Avvisi",
    editor_missing_required_title: "Etichette obbligatorie mancanti",
    problematic_rows_title: "Righe problematiche",
    problematic_rows_empty: "Nessun problema rilevato a livello di riga.",
    problematic_row_heading: "Riga {lineNumber}",
    blocking_errors_row_issues: "{count} problema/i in questa riga",
    problematic_row_hint: "I campi contrassegnati con * sono obbligatori.",
    problematic_row_save: "Convalida modifiche",
    problematic_row_delete: "Elimina riga",
    problematic_row_no_fields: "Nessun campo modificabile rilevato per questa riga.",
    problematic_row_close: "Chiudi editor",
    header_original_column: "Colonna originale",
    header_rename_to: "Rinomina in",
    header_editor_action: "Azione",
    header_detected_target: "Riconoscimento",
    header_overrides_placeholder: "Carica un CSV per modificare i nomi delle colonne.",
    header_manual_column: "Header manuale",
    header_default_value_label: "Valore predefinito",
    header_default_value_placeholder: "Applicato a tutte le righe",
    header_default_value_missing: "Aggiungi un valore predefinito per compilare tutte le righe.",
    header_derived_column: "Colonna derivata",
    header_derived_from: "Estratta da {original}",
    header_derived_sample: "Valore di esempio: {value}",
    header_auto_split_time: "Ora incorporata rilevata: viene creato {header}.",
    header_remove: "Rimuovi",
    header_restore: "Ripristina",
    header_delete: "Elimina",
    header_removed: "Rimossa",
    header_status_validated: "Validata",
    header_status_optional: "Corrispondenza opzionale",
    header_status_unrecognized: "Da rivedere",
    header_status_removed: "Ignorata",
    untitled_header: "Colonna senza titolo #{index}",
    header_match_none: "Non ancora associata",
    header_renamed_from: "da {original}",
    header_override_duplicate_error: "Due o più colonne ora usano lo stesso nome finale: {headers}. Assegna a ogni colonna un nome finale univoco.",
  ...
  pt: {
    ...
    hero_how_title: "Como usar",
    hero_how_copy: "Carregue um CSV, arraste os rótulos esperados para as colunas corretas, corrija os sinais laranja ou vermelhos e depois baixe os três arquivos JSON.",
    hero_minimums_title: "Campos mínimos",
    hero_minimums_copy_html: "<strong>Voo</strong>: data, matrícula, piloto 1 e tempo total de aeronave ou simulador.<br><strong>Aeronave</strong>: fabricante e modelo.<br><strong>Rota</strong>: partida e chegada para linhas que não sejam de simulador.",
    header_overrides_title: "Editor de cabeçalhos CSV",
    header_overrides_copy: "Arraste um rótulo esperado para uma coluna para renomeá-la automaticamente, ou edite manualmente. Você também pode adicionar ou remover cabeçalhos.",
    header_overrides_add: "Adicionar cabeçalho",
    header_overrides_reset: "Redefinir nomes",
    expected_fields_copy: "Arraste um dos rótulos esperados abaixo para uma coluna do CSV.",
    legend_validated: "Verde: rótulo validado",
    legend_optional: "Azul: rótulo opcional reconhecido",
    legend_unrecognized: "Laranja: coluna não reconhecida para revisar",
    legend_error: "Vermelho: problema bloqueador a corrigir",
    editor_metric_validated: "Validados",
    editor_metric_unrecognized: "Não reconhecidos",
    editor_metric_missing: "Obrigatórios ausentes",
    editor_metric_errors: "Erros bloqueadores",
    editor_metric_warnings: "Avisos",
    editor_missing_required_title: "Rótulos obrigatórios ausentes",
    problematic_rows_title: "Linhas problemáticas",
    problematic_rows_empty: "Nenhum problema por linha foi detectado.",
    problematic_row_heading: "Linha {lineNumber}",
    blocking_errors_row_issues: "{count} problema(s) nesta linha",
    problematic_row_hint: "Os campos marcados com * são obrigatórios.",
    problematic_row_save: "Validar alterações",
    problematic_row_delete: "Excluir linha",
    problematic_row_no_fields: "Nenhum campo editável foi detectado para esta linha.",
    problematic_row_close: "Fechar editor",
    header_original_column: "Coluna original",
    header_rename_to: "Renomear para",
    header_editor_action: "Ação",
    header_detected_target: "Reconhecimento",
    header_overrides_placeholder: "Carregue um CSV para editar os nomes das colunas.",
    header_manual_column: "Cabeçalho manual",
    header_default_value_label: "Valor padrão",
    header_default_value_placeholder: "Aplicado a todas as linhas",
    header_default_value_missing: "Adicione um valor padrão para preencher todas as linhas.",
    header_derived_column: "Coluna derivada",
    header_derived_from: "Extraída de {original}",
    header_derived_sample: "Valor de exemplo: {value}",
    header_auto_split_time: "Hora incorporada detectada: cria {header}.",
    header_remove: "Remover",
    header_restore: "Restaurar",
    header_delete: "Excluir",
    header_removed: "Removida",
    header_status_validated: "Validado",
    header_status_optional: "Correspondência opcional",
    header_status_unrecognized: "Precisa de revisão",
    header_status_removed: "Ignorado",
    untitled_header: "Coluna sem título #{index}",
    header_match_none: "Ainda sem correspondência",
    header_renamed_from: "de {original}",
    header_override_duplicate_error: "Duas ou mais colunas agora usam o mesmo nome final: {headers}. Dê a cada coluna um nome final único.",
  ...
  nl: {
    ...
    hero_how_title: "Hoe gebruik je dit",
    hero_how_copy: "Laad een CSV, sleep de verwachte labels naar de juiste kolommen, los oranje of rode signalen op en download daarna de drie JSON-bestanden.",
    hero_minimums_title: "Minimale velden",
    hero_minimums_copy_html: "<strong>Vlucht</strong>: datum, registratie, piloot 1 en totale vliegtuig- of simulatortijd.<br><strong>Vliegtuig</strong>: fabrikant en model.<br><strong>Route</strong>: vertrek en aankomst voor rijen die geen simulatorsessie zijn.",
    header_overrides_title: "CSV-headereditor",
    header_overrides_copy: "Sleep een verwacht label naar een kolom om deze automatisch te hernoemen, of wijzig het handmatig. Je kunt ook kopteksten toevoegen of verwijderen.",
    header_overrides_add: "Header toevoegen",
    header_overrides_reset: "Hernoemen resetten",
    expected_fields_copy: "Sleep een van de verwachte labels hieronder naar een CSV-kolom.",
    legend_validated: "Groen: gevalideerd label",
    legend_optional: "Blauw: herkend optioneel label",
    legend_unrecognized: "Oranje: niet-herkende kolom om te controleren",
    legend_error: "Rood: blokkerend probleem dat moet worden opgelost",
    editor_metric_validated: "Gevalideerd",
    editor_metric_unrecognized: "Niet herkend",
    editor_metric_missing: "Verplichte ontbreken",
    editor_metric_errors: "Blokkerende fouten",
    editor_metric_warnings: "Waarschuwingen",
    editor_missing_required_title: "Ontbrekende verplichte labels",
    problematic_rows_title: "Problematische rijen",
    problematic_rows_empty: "Er zijn geen problemen per rij gevonden.",
    problematic_row_heading: "Regel {lineNumber}",
    blocking_errors_row_issues: "{count} probleem/problemen op deze regel",
    problematic_row_hint: "Velden met * zijn verplicht.",
    problematic_row_save: "Wijzigingen bevestigen",
    problematic_row_delete: "Regel verwijderen",
    problematic_row_no_fields: "Er is geen bewerkbaar veld gevonden voor deze regel.",
    problematic_row_close: "Editor sluiten",
    header_original_column: "Oorspronkelijke kolom",
    header_rename_to: "Hernoemen naar",
    header_editor_action: "Actie",
    header_detected_target: "Herkenning",
    header_overrides_placeholder: "Laad een CSV om kolomnamen te bewerken.",
    header_manual_column: "Handmatige header",
    header_default_value_label: "Standaardwaarde",
    header_default_value_placeholder: "Wordt op alle rijen toegepast",
    header_default_value_missing: "Voeg een standaardwaarde toe om alle rijen te vullen.",
    header_derived_column: "Afgeleide kolom",
    header_derived_from: "Afgeleid van {original}",
    header_derived_sample: "Voorbeeldwaarde: {value}",
    header_auto_split_time: "Ingesloten tijd gedetecteerd: {header} wordt gemaakt.",
    header_remove: "Verwijderen",
    header_restore: "Herstellen",
    header_delete: "Wissen",
    header_removed: "Verwijderd",
    header_status_validated: "Gevalideerd",
    header_status_optional: "Optionele overeenkomst",
    header_status_unrecognized: "Moet worden nagekeken",
    header_status_removed: "Genegeerd",
    untitled_header: "Kolom zonder titel #{index}",
    header_match_none: "Nog niet gekoppeld",
    header_renamed_from: "van {original}",
    header_override_duplicate_error: "Twee of meer kolommen gebruiken nu dezelfde uiteindelijke naam: {headers}. Geef elke kolom een unieke uiteindelijke naam.",
  ...
  pl: {
    ...
    hero_how_title: "Jak tego używać",
    hero_how_copy: "Wczytaj plik CSV, przeciągnij oczekiwane etykiety na właściwe kolumny, popraw pomarańczowe lub czerwone sygnały, a następnie pobierz trzy pliki JSON.",
    hero_minimums_title: "Pola minimalne",
    hero_minimums_copy_html: "<strong>Lot</strong>: data, rejestracja, pilot 1 i całkowity czas samolotu lub symulatora.<br><strong>Statek powietrzny</strong>: producent i model.<br><strong>Trasa</strong>: odlot i przylot dla wierszy, które nie są sesjami symulatora.",
    header_overrides_title: "Edytor nagłówków CSV",
    header_overrides_copy: "Przeciągnij oczekiwaną etykietę na kolumnę, aby automatycznie zmienić jej nazwę, albo edytuj ją ręcznie. Możesz też dodawać i usuwać nagłówki.",
    header_overrides_add: "Dodaj nagłówek",
    header_overrides_reset: "Resetuj nazwy",
    expected_fields_copy: "Przeciągnij jedną z oczekiwanych etykiet poniżej na kolumnę CSV.",
    legend_validated: "Zielony: zatwierdzona etykieta",
    legend_optional: "Niebieski: rozpoznana etykieta opcjonalna",
    legend_unrecognized: "Pomarańczowy: nierozpoznana kolumna do sprawdzenia",
    legend_error: "Czerwony: błąd blokujący do poprawy",
    editor_metric_validated: "Zatwierdzone",
    editor_metric_unrecognized: "Nierozpoznane",
    editor_metric_missing: "Brak wymaganych",
    editor_metric_errors: "Błędy blokujące",
    editor_metric_warnings: "Ostrzeżenia",
    editor_missing_required_title: "Brakujące wymagane etykiety",
    problematic_rows_title: "Problematyczne wiersze",
    problematic_rows_empty: "Nie wykryto problemów na poziomie wierszy.",
    problematic_row_heading: "Wiersz {lineNumber}",
    blocking_errors_row_issues: "{count} problem(y) w tym wierszu",
    problematic_row_hint: "Pola oznaczone * są obowiązkowe.",
    problematic_row_save: "Zatwierdź zmiany",
    problematic_row_delete: "Usuń wiersz",
    problematic_row_no_fields: "Nie wykryto edytowalnych pól dla tego wiersza.",
    problematic_row_close: "Zamknij edytor",
    header_original_column: "Kolumna oryginalna",
    header_rename_to: "Zmień nazwę na",
    header_editor_action: "Akcja",
    header_detected_target: "Rozpoznanie",
    header_overrides_placeholder: "Wczytaj CSV, aby edytować nazwy kolumn.",
    header_manual_column: "Nagłówek ręczny",
    header_default_value_label: "Wartość domyślna",
    header_default_value_placeholder: "Stosowana do wszystkich wierszy",
    header_default_value_missing: "Dodaj wartość domyślną, aby uzupełnić wszystkie wiersze.",
    header_derived_column: "Kolumna pochodna",
    header_derived_from: "Wyodrębniona z {original}",
    header_derived_sample: "Przykładowa wartość: {value}",
    header_auto_split_time: "Wykryto osadzoną godzinę: tworzona jest kolumna {header}.",
    header_remove: "Usuń",
    header_restore: "Przywróć",
    header_delete: "Skasuj",
    header_removed: "Usunięta",
    header_status_validated: "Zatwierdzona",
    header_status_optional: "Opcjonalne dopasowanie",
    header_status_unrecognized: "Wymaga sprawdzenia",
    header_status_removed: "Zignorowana",
    untitled_header: "Kolumna bez tytułu #{index}",
    header_match_none: "Jeszcze nie dopasowano",
    header_renamed_from: "z {original}",
    header_override_duplicate_error: "Dwie lub więcej kolumn używają teraz tej samej końcowej nazwy: {headers}. Nadaj każdej kolumnie unikalną końcową nazwę.",
  ...
  tr: {
    ...
    hero_how_title: "Nasıl kullanılır",
    hero_how_copy: "Bir CSV yükleyin, beklenen etiketleri doğru sütunlara sürükleyin, turuncu veya kırmızı sinyalleri düzeltin ve ardından üç JSON dosyasını indirin.",
    hero_minimums_title: "Asgari alanlar",
    hero_minimums_copy_html: "<strong>Uçuş</strong>: tarih, tescil, pilot 1 ve toplam uçak veya simülatör süresi.<br><strong>Uçak</strong>: üretici ve model.<br><strong>Rota</strong>: simülatör olmayan satırlar için kalkış ve varış.",
    header_overrides_title: "CSV başlık düzenleyici",
    header_overrides_copy: "Beklenen bir etiketi bir sütunun üzerine sürükleyerek onu otomatik olarak yeniden adlandırın ya da elle düzenleyin. Ayrıca başlık ekleyebilir veya kaldırabilirsiniz.",
    header_overrides_add: "Başlık ekle",
    header_overrides_reset: "Yeniden adlandırmayı sıfırla",
    expected_fields_copy: "Aşağıdaki beklenen etiketlerden birini bir CSV sütununun üzerine sürükleyin.",
    legend_validated: "Yeşil: doğrulanmış etiket",
    legend_optional: "Mavi: tanınan isteğe bağlı etiket",
    legend_unrecognized: "Turuncu: gözden geçirilecek tanınmayan sütun",
    legend_error: "Kırmızı: düzeltilmesi gereken engelleyici sorun",
    editor_metric_validated: "Doğrulandı",
    editor_metric_unrecognized: "Tanınmadı",
    editor_metric_missing: "Zorunlu eksik",
    editor_metric_errors: "Engelleyici hatalar",
    editor_metric_warnings: "Uyarılar",
    editor_missing_required_title: "Eksik zorunlu etiketler",
    problematic_rows_title: "Sorunlu satırlar",
    problematic_rows_empty: "Satır bazında bir sorun tespit edilmedi.",
    problematic_row_heading: "Satır {lineNumber}",
    blocking_errors_row_issues: "Bu satırda {count} sorun var",
    problematic_row_hint: "* ile işaretlenen alanlar zorunludur.",
    problematic_row_save: "Değişiklikleri doğrula",
    problematic_row_delete: "Satırı sil",
    problematic_row_no_fields: "Bu satır için düzenlenebilir alan tespit edilmedi.",
    problematic_row_close: "Düzenleyiciyi kapat",
    header_original_column: "Orijinal sütun",
    header_rename_to: "Şu adla yeniden adlandır",
    header_editor_action: "İşlem",
    header_detected_target: "Tanıma",
    header_overrides_placeholder: "Sütun adlarını düzenlemek için bir CSV yükleyin.",
    header_manual_column: "Elle eklenen başlık",
    header_default_value_label: "Varsayılan değer",
    header_default_value_placeholder: "Tüm satırlara uygulanır",
    header_default_value_missing: "Tüm satırları doldurmak için bir varsayılan değer ekleyin.",
    header_derived_column: "Türetilmiş sütun",
    header_derived_from: "{original} içinden çıkarıldı",
    header_derived_sample: "Örnek değer: {value}",
    header_auto_split_time: "Gömülü saat algılandı: {header} oluşturulur.",
    header_remove: "Kaldır",
    header_restore: "Geri yükle",
    header_delete: "Sil",
    header_removed: "Kaldırıldı",
    header_status_validated: "Doğrulandı",
    header_status_optional: "İsteğe bağlı eşleşme",
    header_status_unrecognized: "Gözden geçirilmeli",
    header_status_removed: "Yok sayıldı",
    untitled_header: "Başlıksız sütun #{index}",
    header_match_none: "Henüz eşleşmedi",
    header_renamed_from: "{original} kaynağından",
    header_override_duplicate_error: "İki veya daha fazla sütun artık aynı nihai adı kullanıyor: {headers}. Her sütuna benzersiz bir nihai ad verin.",
  ...
  ru: {
    ...
    hero_how_title: "Как пользоваться",
    hero_how_copy: "Загрузите CSV, перетащите ожидаемые метки на нужные столбцы, исправьте оранжевые или красные сигналы, а затем скачайте три JSON-файла.",
    hero_minimums_title: "Минимальные поля",
    hero_minimums_copy_html: "<strong>Полет</strong>: дата, регистрация, пилот 1 и общее время самолета или симулятора.<br><strong>Воздушное судно</strong>: производитель и модель.<br><strong>Маршрут</strong>: вылет и прилет для строк, которые не относятся к симулятору.",
    header_overrides_title: "Редактор заголовков CSV",
    header_overrides_copy: "Перетащите ожидаемую метку на столбец, чтобы автоматически переименовать его, либо измените название вручную. Вы также можете добавлять или удалять заголовки.",
    header_overrides_add: "Добавить заголовок",
    header_overrides_reset: "Сбросить переименования",
    expected_fields_copy: "Перетащите одну из ожидаемых меток ниже на столбец CSV.",
    legend_validated: "Зеленый: подтвержденная метка",
    legend_optional: "Синий: распознанная необязательная метка",
    legend_unrecognized: "Оранжевый: нераспознанный столбец для проверки",
    legend_error: "Красный: блокирующая проблема, которую нужно исправить",
    editor_metric_validated: "Подтверждено",
    editor_metric_unrecognized: "Не распознано",
    editor_metric_missing: "Отсутствуют обязательные",
    editor_metric_errors: "Блокирующие ошибки",
    editor_metric_warnings: "Предупреждения",
    editor_missing_required_title: "Отсутствующие обязательные метки",
    problematic_rows_title: "Проблемные строки",
    problematic_rows_empty: "Проблем на уровне строк не обнаружено.",
    problematic_row_heading: "Строка {lineNumber}",
    blocking_errors_row_issues: "{count} проблем(ы) в этой строке",
    problematic_row_hint: "Поля, отмеченные *, обязательны.",
    problematic_row_save: "Подтвердить изменения",
    problematic_row_delete: "Удалить строку",
    problematic_row_no_fields: "Для этой строки не найдено редактируемых полей.",
    problematic_row_close: "Закрыть редактор",
    header_original_column: "Исходный столбец",
    header_rename_to: "Переименовать в",
    header_editor_action: "Действие",
    header_detected_target: "Распознавание",
    header_overrides_placeholder: "Загрузите CSV, чтобы изменить названия столбцов.",
    header_manual_column: "Ручной заголовок",
    header_default_value_label: "Значение по умолчанию",
    header_default_value_placeholder: "Применяется ко всем строкам",
    header_default_value_missing: "Добавьте значение по умолчанию, чтобы заполнить все строки.",
    header_derived_column: "Производный столбец",
    header_derived_from: "Извлечено из {original}",
    header_derived_sample: "Пример значения: {value}",
    header_auto_split_time: "Обнаружено встроенное время: создается {header}.",
    header_remove: "Удалить",
    header_restore: "Восстановить",
    header_delete: "Стереть",
    header_removed: "Удален",
    header_status_validated: "Подтверждено",
    header_status_optional: "Необязательное совпадение",
    header_status_unrecognized: "Требует проверки",
    header_status_removed: "Игнорируется",
    untitled_header: "Столбец без названия #{index}",
    header_match_none: "Пока не сопоставлено",
    header_renamed_from: "из {original}",
    header_override_duplicate_error: "Два или более столбца теперь используют одно и то же итоговое имя: {headers}. Дайте каждому столбцу уникальное итоговое имя.",
  ...
  ar: {
    ...
    hero_how_title: "كيفية الاستخدام",
    hero_how_copy: "حمّل ملف CSV، واسحب التسميات المتوقعة إلى الأعمدة الصحيحة، وصحّح الإشارات البرتقالية أو الحمراء، ثم نزّل ملفات JSON الثلاثة.",
    hero_minimums_title: "الحقول الدنيا",
    hero_minimums_copy_html: "<strong>الرحلة</strong>: التاريخ، التسجيل، الطيار 1، وإجمالي وقت الطائرة أو المحاكي.<br><strong>الطائرة</strong>: الشركة المصنعة والطراز.<br><strong>المسار</strong>: المغادرة والوصول للصفوف التي ليست جلسات محاكاة.",
    header_overrides_title: "محرر رؤوس CSV",
    header_overrides_copy: "اسحب تسمية متوقعة إلى عمود لإعادة تسميته تلقائيًا، أو عدّله يدويًا. يمكنك أيضًا إضافة الرؤوس أو حذفها.",
    header_overrides_add: "إضافة رأس",
    header_overrides_reset: "إعادة تعيين إعادة التسمية",
    expected_fields_copy: "اسحب إحدى التسميات المتوقعة أدناه إلى عمود CSV.",
    legend_validated: "أخضر: تسمية معتمدة",
    legend_optional: "أزرق: تسمية اختيارية معروفة",
    legend_unrecognized: "برتقالي: عمود غير معروف يحتاج إلى مراجعة",
    legend_error: "أحمر: مشكلة مانعة يجب تصحيحها",
    editor_metric_validated: "تم التحقق",
    editor_metric_unrecognized: "غير معروف",
    editor_metric_missing: "الحقول الإلزامية المفقودة",
    editor_metric_errors: "أخطاء مانعة",
    editor_metric_warnings: "تحذيرات",
    editor_missing_required_title: "التسميات الإلزامية المفقودة",
    problematic_rows_title: "الصفوف الإشكالية",
    problematic_rows_empty: "لم يتم اكتشاف أي مشكلة على مستوى الصفوف.",
    problematic_row_heading: "السطر {lineNumber}",
    blocking_errors_row_issues: "{count} مشكلة في هذا السطر",
    problematic_row_hint: "الحقول المعلّمة بـ * إلزامية.",
    problematic_row_save: "اعتماد التغييرات",
    problematic_row_delete: "حذف السطر",
    problematic_row_no_fields: "لم يتم اكتشاف أي حقل قابل للتعديل لهذا السطر.",
    problematic_row_close: "إغلاق المحرر",
    header_original_column: "العمود الأصلي",
    header_rename_to: "إعادة التسمية إلى",
    header_editor_action: "الإجراء",
    header_detected_target: "التعرّف",
    header_overrides_placeholder: "حمّل ملف CSV لتعديل أسماء الأعمدة.",
    header_manual_column: "رأس يدوي",
    header_default_value_label: "القيمة الافتراضية",
    header_default_value_placeholder: "تُطبَّق على جميع الصفوف",
    header_default_value_missing: "أضف قيمة افتراضية لملء جميع الصفوف.",
    header_derived_column: "عمود مشتق",
    header_derived_from: "مستخرج من {original}",
    header_derived_sample: "قيمة مثال: {value}",
    header_auto_split_time: "تم اكتشاف وقت مضمّن: سيتم إنشاء {header}.",
    header_remove: "إزالة",
    header_restore: "استعادة",
    header_delete: "مسح",
    header_removed: "تمت الإزالة",
    header_status_validated: "تم التحقق",
    header_status_optional: "مطابقة اختيارية",
    header_status_unrecognized: "يحتاج إلى مراجعة",
    header_status_removed: "تم تجاهله",
    untitled_header: "عمود بلا عنوان #{index}",
    header_match_none: "لم تتم المطابقة بعد",
    header_renamed_from: "من {original}",
    header_override_duplicate_error: "يوجد عمودان أو أكثر يستخدمان الآن الاسم النهائي نفسه: {headers}. امنح كل عمود اسمًا نهائيًا فريدًا.",
  ...
  hi: {
    ...
    hero_how_title: "इसे कैसे इस्तेमाल करें",
    hero_how_copy: "एक CSV लोड करें, अपेक्षित लेबल सही कॉलम पर ड्रैग करें, नारंगी या लाल संकेत ठीक करें, फिर तीनों JSON फ़ाइलें डाउनलोड करें।",
    hero_minimums_title: "न्यूनतम फ़ील्ड",
    hero_minimums_copy_html: "<strong>उड़ान</strong>: तारीख, रजिस्ट्रेशन, पायलट 1, और कुल विमान या सिम्युलेटर समय।<br><strong>विमान</strong>: निर्माता और मॉडल।<br><strong>मार्ग</strong>: उन पंक्तियों के लिए प्रस्थान और आगमन जो सिम्युलेटर सत्र नहीं हैं।",
    header_overrides_title: "CSV हेडर संपादक",
    header_overrides_copy: "किसी अपेक्षित लेबल को किसी कॉलम पर ड्रैग करके उसका नाम अपने आप बदलें, या उसे मैन्युअली संपादित करें। आप हेडर जोड़ या हटा भी सकते हैं।",
    header_overrides_add: "हेडर जोड़ें",
    header_overrides_reset: "नाम बदलना रीसेट करें",
    expected_fields_copy: "नीचे दिए गए अपेक्षित लेबलों में से किसी एक को CSV कॉलम पर ड्रैग करें।",
    legend_validated: "हरा: सत्यापित लेबल",
    legend_optional: "नीला: पहचाना गया वैकल्पिक लेबल",
    legend_unrecognized: "नारंगी: जाँच के लिए अपरिचित कॉलम",
    legend_error: "लाल: ठीक की जाने वाली अवरोधक समस्या",
    editor_metric_validated: "सत्यापित",
    editor_metric_unrecognized: "अपरिचित",
    editor_metric_missing: "अनिवार्य फ़ील्ड गायब",
    editor_metric_errors: "अवरोधक त्रुटियाँ",
    editor_metric_warnings: "चेतावनियाँ",
    editor_missing_required_title: "गायब अनिवार्य लेबल",
    problematic_rows_title: "समस्याग्रस्त पंक्तियाँ",
    problematic_rows_empty: "पंक्ति-स्तर की कोई समस्या नहीं मिली।",
    problematic_row_heading: "पंक्ति {lineNumber}",
    blocking_errors_row_issues: "इस पंक्ति में {count} समस्या/समस्याएँ",
    problematic_row_hint: "* से चिह्नित फ़ील्ड अनिवार्य हैं।",
    problematic_row_save: "परिवर्तन सत्यापित करें",
    problematic_row_delete: "पंक्ति हटाएँ",
    problematic_row_no_fields: "इस पंक्ति के लिए कोई संपादन योग्य फ़ील्ड नहीं मिला।",
    problematic_row_close: "संपादक बंद करें",
    header_original_column: "मूल कॉलम",
    header_rename_to: "इस नाम से बदलें",
    header_editor_action: "कार्रवाई",
    header_detected_target: "पहचान",
    header_overrides_placeholder: "कॉलम नाम संपादित करने के लिए CSV लोड करें।",
    header_manual_column: "मैन्युअल हेडर",
    header_default_value_label: "डिफ़ॉल्ट मान",
    header_default_value_placeholder: "सभी पंक्तियों पर लागू",
    header_default_value_missing: "सभी पंक्तियाँ भरने के लिए एक डिफ़ॉल्ट मान जोड़ें।",
    header_derived_column: "व्युत्पन्न कॉलम",
    header_derived_from: "{original} से निकाला गया",
    header_derived_sample: "उदाहरण मान: {value}",
    header_auto_split_time: "एंबेडेड समय मिला: {header} बनाया जाएगा।",
    header_remove: "हटाएँ",
    header_restore: "पुनर्स्थापित करें",
    header_delete: "मिटाएँ",
    header_removed: "हटाया गया",
    header_status_validated: "सत्यापित",
    header_status_optional: "वैकल्पिक मिलान",
    header_status_unrecognized: "समीक्षा आवश्यक",
    header_status_removed: "अनदेखा किया गया",
    untitled_header: "बिना शीर्षक का कॉलम #{index}",
    header_match_none: "अभी तक मिलान नहीं हुआ",
    header_renamed_from: "{original} से",
    header_override_duplicate_error: "अब दो या अधिक कॉलम एक ही अंतिम नाम का उपयोग कर रहे हैं: {headers}. हर कॉलम को एक अलग अंतिम नाम दें।",
  ...
  zh: {
    ...
    hero_how_title: "如何使用",
    hero_how_copy: "加载一个 CSV，将预期标签拖到正确的列上，修复橙色或红色提示，然后下载三个 JSON 文件。",
    hero_minimums_title: "最少字段",
    hero_minimums_copy_html: "<strong>飞行</strong>：日期、注册号、飞行员 1，以及飞机或模拟器总时长。<br><strong>飞机</strong>：制造商和型号。<br><strong>航线</strong>：对于非模拟器行，需要出发和到达。",
    header_overrides_title: "CSV 表头编辑器",
    header_overrides_copy: "将预期标签拖到某一列上即可自动重命名，也可以手动修改。你也可以添加或删除表头。",
    header_overrides_add: "添加表头",
    header_overrides_reset: "重置重命名",
    expected_fields_copy: "将下方一个预期标签拖到某一 CSV 列上。",
    legend_validated: "绿色：已验证标签",
    legend_optional: "蓝色：已识别的可选标签",
    legend_unrecognized: "橙色：待检查的未识别列",
    legend_error: "红色：需要修复的阻塞问题",
    editor_metric_validated: "已验证",
    editor_metric_unrecognized: "未识别",
    editor_metric_missing: "缺少必填项",
    editor_metric_errors: "阻塞错误",
    editor_metric_warnings: "警告",
    editor_missing_required_title: "缺少的必填标签",
    problematic_rows_title: "问题行",
    problematic_rows_empty: "未检测到任何按行的问题。",
    problematic_row_heading: "第 {lineNumber} 行",
    blocking_errors_row_issues: "这一行有 {count} 个问题",
    problematic_row_hint: "带 * 的字段为必填。",
    problematic_row_save: "确认修改",
    problematic_row_delete: "删除此行",
    problematic_row_no_fields: "未检测到该行的可编辑字段。",
    problematic_row_close: "关闭编辑器",
    header_original_column: "原始列",
    header_rename_to: "重命名为",
    header_editor_action: "操作",
    header_detected_target: "识别结果",
    header_overrides_placeholder: "加载 CSV 以编辑列名。",
    header_manual_column: "手动表头",
    header_default_value_label: "默认值",
    header_default_value_placeholder: "应用到所有行",
    header_default_value_missing: "请添加默认值以填充所有行。",
    header_derived_column: "派生列",
    header_derived_from: "从 {original} 提取",
    header_derived_sample: "示例值：{value}",
    header_auto_split_time: "检测到内嵌时间：将创建 {header}。",
    header_remove: "移除",
    header_restore: "恢复",
    header_delete: "删除",
    header_removed: "已移除",
    header_status_validated: "已验证",
    header_status_optional: "可选匹配",
    header_status_unrecognized: "需要检查",
    header_status_removed: "已忽略",
    untitled_header: "未命名列 #{index}",
    header_match_none: "尚未匹配",
    header_renamed_from: "来自 {original}",
    header_override_duplicate_error: "两个或更多列现在使用同一个最终名称：{headers}。请为每一列指定唯一的最终名称。",
  ...
  ja: {
    ...
    hero_how_title: "使い方",
    hero_how_copy: "CSV を読み込み、想定ラベルを正しい列へドラッグし、オレンジ色や赤色の警告を修正してから、3 つの JSON ファイルをダウンロードしてください。",
    hero_minimums_title: "最低限必要な項目",
    hero_minimums_copy_html: "<strong>フライト</strong>: 日付、機体登録、パイロット 1、総飛行時間またはシミュレーター時間。<br><strong>機体</strong>: メーカーとモデル。<br><strong>経路</strong>: シミュレーター以外の行では出発地と到着地。",
    header_overrides_title: "CSV ヘッダーエディター",
    header_overrides_copy: "想定ラベルを列へドラッグすると自動で名前を変更できます。手動で編集することもでき、ヘッダーの追加や削除も可能です。",
    header_overrides_add: "ヘッダーを追加",
    header_overrides_reset: "リネームをリセット",
    expected_fields_copy: "以下の想定ラベルのいずれかを CSV 列へドラッグしてください。",
    legend_validated: "緑: 確認済みラベル",
    legend_optional: "青: 認識された任意ラベル",
    legend_unrecognized: "オレンジ: 確認が必要な未認識列",
    legend_error: "赤: 修正が必要なブロッキング問題",
    editor_metric_validated: "確認済み",
    editor_metric_unrecognized: "未認識",
    editor_metric_missing: "必須不足",
    editor_metric_errors: "ブロッキングエラー",
    editor_metric_warnings: "警告",
    editor_missing_required_title: "不足している必須ラベル",
    problematic_rows_title: "問題のある行",
    problematic_rows_empty: "行レベルの問題は検出されていません。",
    problematic_row_heading: "{lineNumber} 行目",
    blocking_errors_row_issues: "この行に {count} 件の問題があります",
    problematic_row_hint: "* が付いた項目は必須です。",
    problematic_row_save: "変更を確定",
    problematic_row_delete: "行を削除",
    problematic_row_no_fields: "この行で編集可能な項目は見つかりませんでした。",
    problematic_row_close: "エディターを閉じる",
    header_original_column: "元の列",
    header_rename_to: "変更後の名前",
    header_editor_action: "操作",
    header_detected_target: "認識結果",
    header_overrides_placeholder: "列名を編集するには CSV を読み込んでください。",
    header_manual_column: "手動ヘッダー",
    header_default_value_label: "デフォルト値",
    header_default_value_placeholder: "すべての行に適用",
    header_default_value_missing: "すべての行を埋めるためにデフォルト値を追加してください。",
    header_derived_column: "派生列",
    header_derived_from: "{original} から抽出",
    header_derived_sample: "サンプル値: {value}",
    header_auto_split_time: "埋め込み時刻を検出: {header} を作成します。",
    header_remove: "削除",
    header_restore: "復元",
    header_delete: "消去",
    header_removed: "削除済み",
    header_status_validated: "確認済み",
    header_status_optional: "任意の一致",
    header_status_unrecognized: "要確認",
    header_status_removed: "無視",
    untitled_header: "無題の列 #{index}",
    header_match_none: "まだ一致していません",
    header_renamed_from: "{original} から",
    header_override_duplicate_error: "2 つ以上の列が同じ最終名を使っています: {headers}。各列に一意の最終名を付けてください。",
  ...
  ko: {
    ...
    hero_how_title: "사용 방법",
    hero_how_copy: "CSV를 불러오고, 예상 라벨을 올바른 열로 드래그한 뒤, 주황색 또는 빨간색 신호를 수정하고, 마지막으로 세 개의 JSON 파일을 다운로드하세요.",
    hero_minimums_title: "최소 필수 항목",
    hero_minimums_copy_html: "<strong>비행</strong>: 날짜, 등록기호, 조종사 1, 그리고 항공기 또는 시뮬레이터 총 시간.<br><strong>항공기</strong>: 제조사와 모델.<br><strong>경로</strong>: 시뮬레이터 세션이 아닌 행에는 출발지와 도착지가 필요합니다.",
    header_overrides_title: "CSV 헤더 편집기",
    header_overrides_copy: "예상 라벨을 열로 드래그하면 자동으로 이름을 바꿀 수 있고, 직접 수정할 수도 있습니다. 헤더를 추가하거나 삭제할 수도 있습니다.",
    header_overrides_add: "헤더 추가",
    header_overrides_reset: "이름 변경 초기화",
    expected_fields_copy: "아래의 예상 라벨 중 하나를 CSV 열로 드래그하세요.",
    legend_validated: "초록: 검증된 라벨",
    legend_optional: "파랑: 인식된 선택 라벨",
    legend_unrecognized: "주황: 검토가 필요한 미인식 열",
    legend_error: "빨강: 수정이 필요한 차단 문제",
    editor_metric_validated: "검증됨",
    editor_metric_unrecognized: "미인식",
    editor_metric_missing: "필수 누락",
    editor_metric_errors: "차단 오류",
    editor_metric_warnings: "경고",
    editor_missing_required_title: "누락된 필수 라벨",
    problematic_rows_title: "문제가 있는 행",
    problematic_rows_empty: "행 수준 문제는 감지되지 않았습니다.",
    problematic_row_heading: "{lineNumber}행",
    blocking_errors_row_issues: "이 행에 문제 {count}개",
    problematic_row_hint: "* 표시가 있는 필드는 필수입니다.",
    problematic_row_save: "변경 사항 확인",
    problematic_row_delete: "행 삭제",
    problematic_row_no_fields: "이 행에서 편집 가능한 필드를 찾지 못했습니다.",
    problematic_row_close: "편집기 닫기",
    header_original_column: "원본 열",
    header_rename_to: "다음 이름으로 변경",
    header_editor_action: "동작",
    header_detected_target: "인식",
    header_overrides_placeholder: "열 이름을 수정하려면 CSV를 불러오세요.",
    header_manual_column: "수동 헤더",
    header_default_value_label: "기본값",
    header_default_value_placeholder: "모든 행에 적용",
    header_default_value_missing: "모든 행을 채우려면 기본값을 추가하세요.",
    header_derived_column: "파생 열",
    header_derived_from: "{original}에서 추출",
    header_derived_sample: "예시 값: {value}",
    header_auto_split_time: "내장 시간이 감지됨: {header}가 생성됩니다.",
    header_remove: "제거",
    header_restore: "복원",
    header_delete: "삭제",
    header_removed: "제거됨",
    header_status_validated: "검증됨",
    header_status_optional: "선택 일치",
    header_status_unrecognized: "검토 필요",
    header_status_removed: "무시됨",
    untitled_header: "제목 없는 열 #{index}",
    header_match_none: "아직 일치하지 않음",
    header_renamed_from: "{original}에서",
    header_override_duplicate_error: "이제 두 개 이상의 열이 같은 최종 이름을 사용합니다: {headers}. 각 열에 고유한 최종 이름을 지정하세요.",
    editor_missing_required_empty: "모든 필수 라벨을 사용할 수 있습니다."
  }
};

for (const [languageCode, translationPatch] of Object.entries(TRANSLATION_COMPLEMENTS)) {
  Object.assign(TRANSLATIONS[languageCode], translationPatch);
}
